               ...
               <center> <img src="images/logo.png" alt="Logo" class="img-fluid"></center>
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="user" name="username" placeholder="Introduzca su usuario" required>
                    </div>
                    <div class="mb-3">
                        <center><label for="pass" class="form-label">Contraseña</label></center>
                        <input type="password" class="form-control" id="pass" name="password" placeholder="Introduzca su contraseña" required>
                    </div>
